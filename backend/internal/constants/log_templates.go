...
var LogTemplates = map[string]string{
	...
	"reservation_reschedule_ok": "reservation reschedule success, reservationID=%d, oldStation=%d, newStation=%d, start=%s, end=%s",
	"reservation_expire_cancel": "reservation expired auto cancel, reservationID=%d, stationID=%d",
